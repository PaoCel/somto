...
import { SUPPORTED_LOCALES, t as i18nT } from "../i18n/index.js";
...
export async function ensureUserDoc(user, opts = {}){
  ...
  await setDoc(ref, {
    ...
    // Da dove arriva l'iscrizione. Prima non si sapeva: le coorti si potevano
    // solo indovinare da `communitySafetyAcceptedSource`, che pero' dice dove
    // e' stato accettato il regolamento, non dove nasce l'account.
    platform: "web",
  }, { merge: true });
