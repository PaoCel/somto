...
if (_fcmReady) {
  try {
    ...
    messaging.onBackgroundMessage((payload) => {
      ...
      // Il backend invia sempre il body nella lingua del destinatario. Se un
      // payload legacy non lo contiene, meglio nessun sottotitolo che un
      // fallback italiano su un dispositivo inglese.
...
const VERSION = "v219-2026-09-08-tasto-guarda";
