#!/usr/bin/env node
/**
 * import-quiz-questions-wave2.js
 *
 * Legge quiz_beta/quiz_questions_wave2_import_ready.json e scrive ogni domanda
 ...
 *
 * Usage (da functions/):
 *   node scripts/import-quiz-questions-wave2.js            # dry-run
 *   node scripts/import-quiz-questions-wave2.js --write     # applica
 *   node scripts/import-quiz-questions-wave2.js --write --limit 50
 */
...
const SOURCE = path.resolve(__dirname, '../../quiz_beta/quiz_questions_wave2_import_ready.json');
...
async function main() {
  ...
  console.log('Import quiz questions — WAVE2 TITLES (acquisizione)');
  console.log('='.repeat(60));
