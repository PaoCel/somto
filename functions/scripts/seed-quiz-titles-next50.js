#!/usr/bin/env node
/**
 * seed-quiz-titles-next50.js
 *
 * Crea i doc `titles/{tmdb_<type>_<id>}` mancanti per i titoli del batch quiz
 * acquisizione marcati needsTmdbImport in quiz_beta/quiz_next50_titles.json.
 *
 ...
 *
 * Usage (da functions/):
 *   node scripts/seed-quiz-titles-next50.js            # dry-run
 *   node scripts/seed-quiz-titles-next50.js --write      # applica
 */
...
const TITLES = JSON.parse(fs.readFileSync(path.resolve(__dirname, '../../quiz_beta/quiz_next50_titles.json'), 'utf8'))
