...
function extractTitleFeatures(title) {
  ...
  // `meta.originCountry` e' l'unico posto dove il paese esiste davvero: i campi
  // top-level qui sopra non sono mai stati popolati su nessun titolo, quindi
  // fino al 2026-08-26 il bucket `countries` era vuoto su 205 profili su 205.
  let countries;
  ...
  else if (Array.isArray(t.meta?.originCountry)) countries = take(t.meta.originCountry, FEATURE_TAKE.countries);
