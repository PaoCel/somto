...
enum CloudFunctionsCaller {
    ...
    static func call(
        ...
        do {
            ...
            // Le callable storiche non impongono App Check e devono restare
            // disponibili durante un disservizio di attestazione. Quelle che
            // lo impongono rifiuteranno correttamente la richiesta senza token.
            SilentFailure.record(error, context: "Functions.appCheckToken")
            appCheckToken = nil
        }
