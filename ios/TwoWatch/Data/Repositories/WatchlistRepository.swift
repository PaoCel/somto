...
final class WatchlistRepository {
    ...
    func buildNaturalListPreview(_ phrase: String) async throws -> NaturalListPreview {
        ...
        let description = normalized.contains("cronologic")
            ? String(localized: "Bozza generata da input naturale. Conferma i titoli e riordinali se serve.")
            : String(localized: "Bozza generata da input naturale. Rivedi i titoli prima di confermare.")
    ...
    func toggleWatchlist(userID: String, titleID: String, source: String = "ios_title_detail") async throws -> Bool {
        ...
        // Rewatch solo per i titoli FINITI. Una serie iniziata torna
        // semplicemente in "Da vedere" (il backend lo consente): prima un
        // singolo episodio bastava a dirottare il segnalibro sul rewatch.
