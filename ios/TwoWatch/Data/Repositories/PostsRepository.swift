...
final class PostsRepository {
    ...
    // i18n-ok: messaggio del compilatore per sviluppatori, non UI.
...
private enum PostWriteError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .emptyBody:
            return String(localized: "Scrivi qualcosa prima di pubblicare.")
        case let .bodyTooLong(limit):
            return String(localized: "Il post supera il limite di \(limit) caratteri.")
        }
    }
}
