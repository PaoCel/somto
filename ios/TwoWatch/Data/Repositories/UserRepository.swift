...
final class UserRepository {
    ...
    func ensureUserDocument(for authUser: User, preferredDisplayName: String?) async throws {
        ...
        try await userRef.setData([
            ...
            // Da dove nasce l'account. Serve a leggere le coorti per
            // piattaforma: prima si poteva solo dedurre da
            // `communitySafetyAcceptedSource`, che dice dove e' stato accettato
            // il regolamento, non dove ci si e' iscritti.
            "platform": "ios",
            "stats": [
                "ratingsCount": 0,
                "reviewsCount": 0,
    ...
    // i18n-ok: valore canonico persistito per la moderazione, non copy UI.
