    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            ScrollView(.horizontal, showsIndicators: false) {
                // .top: le card hanno altezza uniforme (vedi TitlePersonCard),
                // ma l'allineamento di default .center le farebbe comunque
                // "galleggiare" in modo incoerente se in futuro cambiasse.
