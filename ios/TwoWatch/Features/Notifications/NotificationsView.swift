...
enum NotificationsFilter: CaseIterable, Identifiable {
    case all
    case unread
    case comments
    ...
    var localizedTitle: String {
        switch self {
        case .all: return String(localized: "Tutte")
        case .unread: return String(localized: "Non lette")
        case .comments: return String(localized: "Commenti")
        }
    }
...
private struct NotificationRowView: View {
    ...
    private var contextLabel: String? {
        ...
        case .title, .titleSlug:
            // MAI il `focus`: e' un parametro di deep link
            // ("updates|tmdb_release_tv_97546_s4_e4") e finiva a schermo
            // capitalizzato sotto la notifica — visto su device il 2026-08-25.
