...
- **Service worker**: `public/service-worker.js`, costante `VERSION` (attuale `v218-2026-09-06-quiz-sfide-copy`, cache tiered shell/runtime/images) — bumpare `VERSION` a ogni release di asset.
