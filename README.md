...
[![CI](https://github.com/PaoCel/2watch/actions/workflows/ci.yml/badge.svg)](https://github.com/PaoCel/2watch/actions/workflows/ci.yml)
[![Security](https://github.com/PaoCel/2watch/actions/workflows/security.yml/badge.svg)](https://github.com/PaoCel/2watch/actions/workflows/security.yml)
...
```bash
git clone https://github.com/PaoCel/2watch.git somto
cd somto
npm ci
...
| Preparare il passaggio a pubblico | [docs/PUBLIC_RELEASE_CHECKLIST.md](docs/PUBLIC_RELEASE_CHECKLIST.md) |
