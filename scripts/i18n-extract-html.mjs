 ...
 *
 * Uso: node scripts/i18n-extract-html.mjs [--lang en] [--json <file>]
 */
...
const lang = langIndex >= 0 ? String(process.argv[langIndex + 1] || "").trim().toLowerCase() : "en";
...
const translated = readFileSync(`public/js/i18n/${lang}.js`, "utf8");
const have = new Set();
for (const m of translated.matchAll(/^\s*"((?:[^"\\]|\\.)*)"\s*:/gm)) {
